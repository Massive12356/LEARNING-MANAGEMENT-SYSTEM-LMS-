  ...
  const loadDashboardData = async () => {
    try {
      ...
      const mockRecentActivity = [
        ...
        { type: 'completion', user: 'Jane Smith', course: 'TypeScript Advanced', time: '4 hours ago' },
        { type: 'registration', user: 'Mike Johnson', time: '6 hours ago' },
        { type: 'course_created', user: 'Sarah Wilson', course: 'JavaScript Fundamentals', time: '1 day ago' }
      ];
      const mockSystemAlerts = [
        { type: 'warning', message: 'Server maintenance scheduled for this weekend', time: '1 hour ago' },
          ...
          <CardContent>
            <div className="space-y-4">
              {dashboardData.recentActivity.map((activity, index) => (
                <div key={index} className="flex items-start p-3 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-900 dark:text-white">
                      {activity.user} {activity.type === 'enrollment' ? 'enrolled in' : 
                       ...
                       activity.type === 'registration' ? 'registered' : 'created'} {activity.course || ''}
                    </p>
          ...
          <CardContent>
            <div className="space-y-4">
              {dashboardData.recentUsers.map((user) => (
                <div key={user.id} className="flex items-center p-3 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg">
            ...
            <Link to="/admin/organization">
              <div className="p-6 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-blue-500 dark:hover:border-blue-400 transition-colors cursor-pointer">
                <div className="text-center">
                  ...
                  <h3 className="font-medium text-gray-900 dark:text-white">Organization Settings</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
