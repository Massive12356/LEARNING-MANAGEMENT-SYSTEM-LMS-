          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div className="space-y-4">
              ...
              <p className="text-slate-300 text-lg max-w-xl leading-relaxed">
                Comprehensive analytics, health metrics, and performance reports across the platform.
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              <div className="bg-white p-1 rounded-xl shadow-lg flex">
                <select
                  ...
                  className="bg-transparent border-none text-slate-900 text-sm focus:ring-0 cursor-pointer font-medium"
                >
              ...
              <Button
                ...
                className="bg-white text-slate-900 hover:bg-slate-50 border-none shadow-lg shadow-black/5 rounded-xl transition-all"
              >
        ...
        <div className="p-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-green-50 dark:bg-green-900/20 rounded-2xl border border-green-100 dark:border-green-800">
              <ServerIcon className="h-10 w-10 mx-auto text-green-600 mb-3" />
              ...
              <div className="text-sm font-medium text-gray-600 dark:text-gray-400">System Uptime</div>
            </div>

            <div className="text-center p-6 bg-blue-50 dark:bg-blue-900/20 rounded-2xl border border-blue-100 dark:border-blue-800">
              <ClockIcon className="h-10 w-10 mx-auto text-blue-600 mb-3" />
              ...
              <div className="text-sm font-medium text-gray-600 dark:text-gray-400">Avg Response Time</div>
            </div>
            ...
            <div className="text-center p-6 bg-purple-50 dark:bg-purple-900/20 rounded-2xl border border-purple-100 dark:border-purple-800">
              <UserGroupIcon className="h-10 w-10 mx-auto text-purple-600 mb-3" />
              ...
              <div className="text-sm font-medium text-gray-600 dark:text-gray-400">Active Connections</div>
            </div>
          </div>
        </div>
      </div>
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                {reportData.organizationPerformance.map((org, index) => {
                  ...
                  return (
                    <tr key={org.name} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                      ...
                      <td className="px-8 py-5 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="w-24 bg-gray-100 dark:bg-gray-700 rounded-full h-2 mr-3">
                            <div
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="p-8 border-b border-gray-100 dark:border-gray-700">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center">
              <ServerStackIcon className="h-6 w-6 mr-2 text-blue-500" />
              Resource Usage
            </h2>
          </div>
          <div className="p-8">
                ...
                <div>
                  ...
                  <div className="mb-6">
                    <div className="flex justify-between text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      ...
                      <span className="text-gray-900 dark:text-white">{usage?.resourceUsage?.storageUsed ?? '0'} / 5TB</span>
                    </div>
                    {(() => {
                  ...
                  <div className="mb-6">
                    <div className="flex justify-between text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      ...
                      <span className="text-gray-900 dark:text-white">{usage?.resourceUsage?.bandwidthUsed ?? '0'} / 2TB</span>
                    </div>
                    {(() => {
                      const { percentage, color } = getUsageBar(
                  ...
                  <div className="mb-8">
                    <div className="flex justify-between text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      ...
                      <span className="text-gray-900 dark:text-white">{usage?.resourceUsage?.databaseSize ?? '0'} / 100GB</span>
                    </div>
                    {(() => {
                      const { percentage, color } = getUsageBar(
                  ...
                  <div className="pt-6 border-t border-gray-100 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="px-3 py-1 text-xs font-semibold bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-full border border-green-200 dark:border-green-800">
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-2xl">
                    <div className="flex items-center space-x-4">
                      ...
                      <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Peak Hours</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-2xl">
                    <div className="flex items-center space-x-4">
                      ...
                      <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Mobile Usage</span>
                    </div>
                    <span className="text-base font-bold text-gray-900 dark:text-white">
